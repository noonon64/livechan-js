...
module.exports = function(data, callback) {
    try {
        ...
        var extension = get_extension(data.image_filename);
        var category = categorize(data.image_filename);
    ...
    try {
        ...
        process.on("close", function(code) {
			...
			for (var i in metadata.streams) {
			    ...
			    if (codec_names !== undefined && !codec_names.includes(metadata.streams[i].codec_name)) {
